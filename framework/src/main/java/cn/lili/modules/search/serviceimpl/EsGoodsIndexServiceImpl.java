...
//        updateRequest.version(promotionMap.size());
    ...
    private EsGoodsIndex wrapperEsGoodsIndex(GoodsSkuDTO goodsSku, List<Map<String, Object>> brandList, List<Map<String, Object>> categoryList, List<Map<String, Object>> storeCategoryList) {
        ...
        if (CollUtil.isNotEmpty(categoryList) && CharSequenceUtil.isNotEmpty(goodsSku.getCategoryPath())) {
            ...
            java.util.Set<String> categoryIds = new java.util.HashSet<>(java.util.Arrays.asList(goodsSku.getCategoryPath().split(",")));
            for (Map<String, Object> o : categoryList) {
                if (categoryIds.contains(o.get("id").toString())) {
                    categoryNamePath.append(o.get("name")).append(",");
                }
            }
        ...
        if (CollUtil.isNotEmpty(storeCategoryList) && CharSequenceUtil.isNotEmpty(goodsSku.getStoreCategoryPath())) {
            ...
            java.util.Set<String> storeCategoryIds = new java.util.HashSet<>(java.util.Arrays.asList(goodsSku.getStoreCategoryPath().split(",")));
            for (Map<String, Object> o : storeCategoryList) {
                if (storeCategoryIds.contains(o.get("id").toString())) {
                    storeCategoryNamePath.append(o.get("label_name").toString()).append(",");
                }
            }
