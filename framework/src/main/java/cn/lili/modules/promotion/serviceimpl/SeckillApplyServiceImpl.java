...
public class SeckillApplyServiceImpl extends ServiceImpl<SeckillApplyMapper, SeckillApply> implements SeckillApplyService {
    ...
    public boolean updateSeckillApplyTime(Seckill seckill) {
        ...
        // Convert hours to Set for O(1) lookup and to prevent substring matching bugs
        java.util.Set<String> hoursSet = java.util.Arrays.stream(seckill.getHours().split(",")).collect(java.util.stream.Collectors.toSet());
