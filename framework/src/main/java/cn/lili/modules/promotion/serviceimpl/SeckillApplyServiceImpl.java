...
public class SeckillApplyServiceImpl extends ServiceImpl<SeckillApplyMapper, SeckillApply> implements SeckillApplyService {
    ...
    public boolean updateSeckillApplyTime(Seckill seckill) {
        ...
        // ⚡ Bolt: Convert comma-separated string to Set outside the stream to achieve O(1) lookups and prevent substring matching bugs
        Set<String> hoursSet = new LinkedHashSet<>(Arrays.asList(seckill.getHours().split(",")));
