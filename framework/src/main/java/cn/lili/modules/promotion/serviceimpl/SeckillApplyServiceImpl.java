...
public class SeckillApplyServiceImpl extends ServiceImpl<SeckillApplyMapper, SeckillApply> implements SeckillApplyService {
    ...
    public boolean updateSeckillApplyTime(Seckill seckill) {
        ...
        // ⚡ Bolt Optimization: Use Set for O(1) lookups instead of String.contains() on delimited string
    ...
    private void checkSeckillApplyList(String hours, List<SeckillApplyVO> seckillApplyList) {
        // ⚡ Bolt Optimization: Use Set for O(1) lookups instead of List.contains()
        java.util.Set<String> existSku = new java.util.LinkedHashSet<>();
        // ⚡ Bolt Optimization: Hoist invariant string split and convert to Set for O(1) lookups outside the loop
