...
public class SeckillApplyServiceImpl extends ServiceImpl<SeckillApplyMapper, SeckillApply> implements SeckillApplyService {
    ...
    public boolean updateSeckillApplyTime(Seckill seckill) {
        ...
        // Parse hours to a Set for O(1) lookup and to prevent substring matching bugs (e.g. "12".contains("1"))
    ...
    private void checkSeckillApplyList(String hours, List<SeckillApplyVO> seckillApplyList) {
        ...
        // Hoist hours.split(",") and create a Set for O(1) lookups outside the loop to avoid redundant allocation and iteration
        ...
        for (SeckillApplyVO seckillApply : seckillApplyList) {
            ...
            // Use Set.add() which safely returns false if the item was already present, performing exist check and insert in one O(1) operation
